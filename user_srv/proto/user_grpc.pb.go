...
type UserClient interface {
	...
	CheckUserPassword(ctx context.Context, in *CheckPasswordInfo, opts ...grpc.CallOption) (*CheckResponse, error)
}
...
func (c *userClient) CheckUserPassword(ctx context.Context, in *CheckPasswordInfo, opts ...grpc.CallOption) (*CheckResponse, error) {
...
type UserServer interface {
	...
	CheckUserPassword(context.Context, *CheckPasswordInfo) (*CheckResponse, error)
}
...
func (UnimplementedUserServer) CheckUserPassword(context.Context, *CheckPasswordInfo) (*CheckResponse, error) {
...
func _User_CheckUserPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CheckUserPassword(ctx, req.(*CheckPasswordInfo))
	}
	return interceptor(ctx, in, info, handler)
}
