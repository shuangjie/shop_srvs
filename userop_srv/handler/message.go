...
func (*UserOpServer) MessageList(_ context.Context, req *proto.MessageRequest) (*proto.MessageListResponse, error) {
...
func (*UserOpServer) CreateMessage(_ context.Context, req *proto.MessageRequest) (*proto.MessageResponse, error) {
